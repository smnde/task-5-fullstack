...
<div class="flex flex-col justify-center items-center">
	...
	<div class="w-full max-w-xs">
		<form class="bg-white shadow-md rounded px-8 pt-4 pb-5 mb-4" action="{{ route('register') }}" method="POST">
			@csrf
			<div class="mb-3">
				<label class="block text-gray-700 text-sm font-bold mb-2" for="name">
					Name
				</label>
				<input class="shadow appearance-none border focus:border-blue-500 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="name" type="text" name="name" placeholder="Your name">
			</div>
			<div class="mb-3">
